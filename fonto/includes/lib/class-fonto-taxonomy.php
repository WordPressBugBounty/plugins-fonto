...
// Dynamic labels are generated by this reusable taxonomy wrapper from the
...
class Fonto_Taxonomy {
	...
	public function add_filter() {
		...
		$post_type = ! empty( $_GET['post_type'] ) ? sanitize_key( wp_unslash( $_GET['post_type'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Read-only list table filter state.
	...
	public function display_filter() {
		...
		$selected = ! empty( $_GET[ $this->taxonomy ] ) ? sanitize_key( wp_unslash( $_GET[ $this->taxonomy ] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Read-only list table filter state.
